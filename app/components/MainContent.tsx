...
export default function MainContent() {
    return (
        <main className="w-full mt-3 lg:mt-4">
            <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-10 mb-3">
                {/* Adjusted grid columns for better proportion */}
                <div className="w-full grid grid-cols-1 lg:grid-cols-[1fr_360px] xl:grid-cols-[1fr_380px] 2xl:grid-cols-[1fr_420px] gap-4 lg:gap-5 xl:gap-6 2xl:gap-8 lg:items-stretch items-start">
                    {/* Left: Video */}
                    ...
                    {/* Right: Text Content */}
                    <div className="flex flex-col w-full h-auto lg:h-full bg-white border border-[#B4BFCC] rounded-[8px] overflow-hidden min-h-[320px] sm:min-h-[360px] md:min-h-[420px] lg:min-h-[480px] xl:min-h-[540px] 2xl:min-h-[580px]">
                        ...
                        <div className="flex-1 px-3 py-2.5 overflow-hidden flex flex-col">
                            <div className="flex flex-col justify-between gap-2 text-right h-full" dir="rtl">
                                ...
                                >
                                    ...
                                    <span className="block">يعمل بالذكاء الاصطناعي من دون أيِّ تدخّلٍ بشريّ،</span>
                                ...
                                >
                                    ...
                                    <span className="block">ليقدّمها لكم بأسلوبٍ بسيطٍ وواضحٍ وسهلٍ الفهم خلال ثوانٍ.</span>
                                </div>
                                ...
                                >
                                    <span className="block">
                                        يُغَطِّي جميعَ الدُّوَلِ العربيِّة: <bdi dir="ltr">Jarayid.com</bdi>&rlm;
                                    </span>
                                    <span className="block">
                                    ...
                                    <span className="block">ليقرب الخبر من كلّ قارئٍ ومُستمعٍ أينما كان.</span>
                                    <span className="block">
                                        الإشعارات الذكية – تُبقيك <bdi dir="ltr">Jarayid.com</bdi>&rlm; على تواصلٍ فوريّ
                                    </span>
                                    <span className="block">
