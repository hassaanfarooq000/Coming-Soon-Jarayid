                ...
                <div className="w-full flex flex-col lg:flex-row gap-4 lg:gap-5 xl:gap-6 2xl:gap-8 items-start">
                    ...
                    <div className="relative w-full aspect-video lg:flex-1 lg:aspect-auto lg:h-[400px] xl:h-[460px] 2xl:h-[500px] rounded-[8px] overflow-hidden shadow-lg bg-gray-900">
                        <iframe
                            ...
                            src="https://www.youtube-nocookie.com/embed?listType=playlist&list=PLLBoDENHUAYdy-gQDhgTQQeKBy6nS6cxP"
                        ...
                        <div className="flex-1 px-3 py-2.5 overflow-y-auto flex flex-col">
                            <div className="flex flex-col justify-between gap-2 text-right h-full" dir="rtl">
                                ...
                                >
                                    ...
                                    <span className="block">
                                        <span className="font-bold">إضافةً إلى أقسامٍ متنوّعة تشمل: البثّ المباشر، الاقتصاد، الرياضة، التكنولوجيا، الصحّة، أخبار العالم، المجتمع، البرامج الحوارية، البودكاست,</span> <span>صوتُ</span> المجتمع,سجّل أنا عربي ونشرات <bdi dir="ltr">Jarayid AI</bdi>&rlm; الإخباريّة الذكيّة
                                    </span>
                                    <span className="block">
                                ...
                                >
                                    ...
                                    <span>بصوتٍ <span className="font-bold">ذكريّ أو أنثويّ</span>، لتبقى على اطلاع حتى أثناء القيادة أو العمل أو الراحة.</span>
